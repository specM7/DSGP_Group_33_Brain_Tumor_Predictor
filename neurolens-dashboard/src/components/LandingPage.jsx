            ...
            <section className="nl-section">
                <div className="nl-section-container">
                    ...
                    <div className="nl-founders-grid">
                        {[
                            { name: 'Malindu Manchanayake', initials: 'MM', linkedin: 'https://www.linkedin.com/in/malindu-manchanayake-8b2b993b1/' },
                            { name: 'Adrian Vethanayagam', initials: 'AV', linkedin: 'https://www.linkedin.com/in/joshua-adrian-/' },
                            { name: 'Vidu Liyanage', initials: 'VL', linkedin: 'https://www.linkedin.com/in/viduliyanage7/' },
                            { name: 'Mohamed Ahshaan', initials: 'MA', linkedin: 'https://www.linkedin.com/in/mohamedahshaan/' },
                        ].map((f, i) => (
                            <a key={i} ref={addRef} href={f.linkedin} target="_blank" rel="noopener noreferrer"
                                className="nl-reveal nl-founder-card" style={{ '--d': i, textDecoration: 'none' }}>
                                ...
                                <svg className="nl-founder-linkedin" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
